...
public class GUIpanelMain extends JPanel implements ActionListener
{
	/******************************************************
	 * STEP 1: Attributes
	 * 
	...
	public Ofaculty [] FacultyGroup;
	public Ostudents [] StudentGroup;
	public Ostaff [] StaffGroup;
	public Oundergraduate [] undergraduateGroup;
	public Ograduate [] graduateGroup;
	...
	//Method: PanelMain()
	//
	//Purpose: The constructor that creates JTextFields, JButtons, JLabels.
	//			   
	//***************************************************************************
	...
	public GUIpanelMain()
	{
		...
		FacultyGroup = new Ofaculty[100];
		StaffGroup = new Ostaff[100];
		StudentGroup = new Ostudents[100];
	...
	public void createMethod()
	{
		...
		{
			FacultyGroup[iFac] = new Ofaculty(fName, lName, facultyDept, facultyCourse);
			iFac++;
			System.out.println("Faculty Member Created");
		}
		else if(!staffDept.equals(SDN))
		{
			StaffGroup[iStaff] = new Ostaff(fName, lName, staffDept, staffDuty);
			iStaff++;
...
//			}
			StudentGroup[iStud] = new Ostudents(fName, lName, studentStatus, studentCourse);
			iStud++;
